 ...
 *
 * ISSUE:
 * https://github.com/android/nav3-recipes/issues/112
 */
...
class SharedViewModelStoreNavEntryDecorator<T : Any>(
    ...
    companion object {
        ...
        internal const val PARENT_CONTENT_KEY = "shared_decorator_parent_content_key"
...
fun NavKey.contentKey() = this.toString()
